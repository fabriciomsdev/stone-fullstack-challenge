...
class WorkCentersEntity(ComplexObjectToJsonEntityMixin):
    ...
    def qty_of_terminals_on_stock(self):
        ...
        terminals_delivered_list = [ 
            exp.qty_of_items for exp in expeditions if exp.was_canceled == False
        ]
...
class ExpeditionsEntity(ComplexObjectToJsonEntityMixin):
    ...
    def __init__(self, id: int = None, qty_of_items: int = 1, was_canceled: bool = False, work_center: WorkCentersEntity = None):
        self.id = id
        self.fill(qty_of_items, was_canceled, work_center)

    def fill(self, qty_of_items: str = None, was_canceled: bool = False, work_center: WorkCentersEntity = None):
